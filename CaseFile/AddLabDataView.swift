    ...
    private var bloodCellSection: some View {
        GroupBox {
            VStack(alignment: .leading, spacing: 12) {
                ...
                HStack {
                    LabValueField(label: "白血球 (WBC)", value: $wbc, unit: "×10³/μL")
                    LabValueField(label: "赤血球 (RBC)", value: $rbc, unit: "×10⁴/μL")
                }
                
                HStack {
                    LabValueField(label: "ヘモグロビン (Hb)", value: $hb, unit: "g/dL")
                ...
                HStack {
                    ...
                    LabValueField(label: "血小板", value: $platelet, unit: "×10⁴/μL")
                }
            }
            .padding()
        }
        ...
        GroupBox {
            VStack(alignment: .leading, spacing: 12) {
                ...
                HStack {
                    ...
                    LabValueField(label: "クレアチニン", value: $creatinine, unit: "mg/dL")
                }
    ...
    private var liverFunctionSection: some View {
        GroupBox {
            VStack(alignment: .leading, spacing: 12) {
                ...
                HStack {
                    LabValueField(label: "γ-GTP", value: $gammaGtp, unit: "U/L")
                    LabValueField(label: "ALP", value: $alp, unit: "U/L")
                }
                
                HStack {
                    LabValueField(label: "LDH", value: $ldh, unit: "U/L")
                    Spacer()
        ...
        GroupBox {
            VStack(alignment: .leading, spacing: 12) {
                ...
                HStack {
                    ...
                    LabValueField(label: "血糖 (Glu)", value: $glucose, unit: "mg/dL")
                }
                
                HStack {
                    LabValueField(label: "HbA1c", value: $hba1c, unit: "%")
                    Spacer()
                        .frame(maxWidth: .infinity)
                }
            }

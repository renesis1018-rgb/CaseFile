...
struct Persistence {
    ...
    func saveSurgery(
        ...
        surgery.preOpVectra = NSNumber(value: preOpVectra)
    ...
    func saveFollowUp(
        ...
        followUp.vectraPerformed = NSNumber(value: vectraPerformed)
        followUp.bodyWeight = bodyWeight.map { NSNumber(value: $0) }
        followUp.smokingStatus = smokingStatus
        followUp.breastQScore = (breastQScore ?? 0) as NSNumber
